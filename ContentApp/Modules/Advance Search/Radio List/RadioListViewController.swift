...
class RadioListViewController: SystemThemableViewController {
    ...
    var viewModel: RadioListViewViewModel { return controller.viewModel }
    lazy var controller: RadioListController = { return RadioListController() }()
    ...
    func registerCells() {
        tableView.register(UINib(nibName: CellConstants.TableCells.listItem, bundle: nil), forCellReuseIdentifier: CellConstants.TableCells.listItem)
    }
...
extension RadioListViewController: UITableViewDelegate, UITableViewDataSource {
...
extension RadioListViewController: SearchComponentsStoryboardInstantiable { }
