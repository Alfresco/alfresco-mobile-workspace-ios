...
class ThemesModeScreenCoordinator: Coordinator {
    ...
    init(with presenter: UINavigationController, accountScreen: AccountViewController) {
        self.presenter = presenter
        self.accountViewController = accountScreen
    }
    ...
    func start() {
        ...
        viewController.delegate = self.accountViewController
