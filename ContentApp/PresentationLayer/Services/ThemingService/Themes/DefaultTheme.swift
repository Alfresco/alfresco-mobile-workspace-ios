...
struct DefaultTheme: PresentationTheme {
    ...
    var onSurface60Color = #colorLiteral(red: 0.1294117647, green: 0.137254902, blue: 0.1568627451, alpha: 0.6)
    var onSurface30Color = #colorLiteral(red: 0.1294117647, green: 0.137254902, blue: 0.1568627451, alpha: 0.3)
    var onSurface15Color = #colorLiteral(red: 0.1294117647, green: 0.137254902, blue: 0.1568627451, alpha: 0.15)
    var onSurface5Color = #colorLiteral(red: 0.1294117647, green: 0.137254902, blue: 0.1568627451, alpha: 0.05)
