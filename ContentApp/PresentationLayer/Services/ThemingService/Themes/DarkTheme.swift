...
struct DarkTheme: PresentationTheme {
   ...
   var headline3TextStyle = TextStyle(font: UIFont.inter(style: .normal, size: 48.0), lineHeight: 1.33, letterSpacing: 0.0)
    ...
    var onSurface60Color = #colorLiteral(red: 0.6274509804, green: 0.6274509804, blue: 0.6274509804, alpha: 1)
    var onSurface30Color = #colorLiteral(red: 0.3490196078, green: 0.3490196078, blue: 0.3490196078, alpha: 1)
    var onSurface15Color = #colorLiteral(red: 0.2117647059, green: 0.2117647059, blue: 0.2117647059, alpha: 1)
    var onSurface5Color = #colorLiteral(red: 0.1176470588, green: 0.1176470588, blue: 0.1176470588, alpha: 1)
    ...
    var primaryVariantT2Color = #colorLiteral(red: 1, green: 0.7764705882, blue: 0, alpha: 1)
    var primaryT2Color = #colorLiteral(red: 1, green: 0.9098039216, blue: 0, alpha: 1)
