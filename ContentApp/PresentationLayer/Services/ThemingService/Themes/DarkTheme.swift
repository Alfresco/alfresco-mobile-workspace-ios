...
struct DarkTheme: PresentationTheme {
   ...
   var headline3TextStyle = TextStyle(font: UIFont.inter(style: .normal, size: 48.0), lineHeight: 1.33, letterSpacing: 0.0)
    ...
    var onSurface60Color = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0.6)
    var onSurface30Color = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0.3)
    var onSurface15Color = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0.15)
    var onSurface5Color = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0.05)
