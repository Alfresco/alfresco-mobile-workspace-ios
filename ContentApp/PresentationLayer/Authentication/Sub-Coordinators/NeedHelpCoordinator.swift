...
class NeedHelpCoordinator: Coordinator {
    private let presenter: UINavigationController
    private var needHelpViewController: NeedHelpViewController?
    private let model: NeedHelpModelProtocol

    init(with presenter: UINavigationController, model: NeedHelpModelProtocol) {
